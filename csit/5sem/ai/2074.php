        ...
        <div class="row justify-content-center">
            ...
            <div class="col-lg-8 col-11 text-center border shadow mb-4" id="paper-model">
                ...
                <div class="text-start">
                    <ol>
                        <li>Define AI with its application. Explain Turing Test Approach.</li>
                        <li>What is constraint satisfaction problem? Solve <br>
                            <img src="../../../images/AI22074.png" alt=""class="img-fluid">
                        </li>
                        <li>Define natural language processing. Explain the level of knowledge used in language understanding.</li>
                        <li>Define rational agent. Show the reachable portoin of the vacuum world if the vacuum world contain eigth different possible states.</li>
                        <li>What is neural network? Why we use neural network?</li>
                        <li>Define fuzzy logic. Explain normal, union, and relative complement with suitable example.</li>
                        <li>Wha is learning? Write down its types.</li>
                        ...
                        <li>Define admissible heuristic and monotonicity. Write an algorithm for A* search with suitable example. Prove: If h(n) is consistent, then the values of f(n) along the path are non-decreasing.</li>
                        <li>a) You are given two jugs, a 4-liters gallon one and a 3 liters gallon one. Neither have any measuing markers on it. There is a pump that can be used to fill the jugs with water. How can you get exactly (4,2) meaning that the 4-liters gallon jug contains 4 liters of water and 3-liters gallon jug contains 2-liters of water? Solve this problem with state space representation.</li>
                        <li>b) Define quantifiers and nested quantifiers. Explain the rules of inference for quantified statement.</li>
                    </ol>
                </div>
            </div>
