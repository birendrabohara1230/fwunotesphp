        ...
        <div class="row justify-content-center">
            ...
            <div class="col-lg-8 col-11 text-center border shadow mb-4" id="paper-model">
                ...
                <div class="text-start">
                    <ol>
                        <li>Is Artificial Intelligence ethical? What are the various areas where AI can be used?</li>
                        <li>What is an artifical intelligence Neural Networks? Differentiate between neural networks and conventional computers.</li>
                        <li>HOw is machine learning related to Artifical Intelligence? Explain about concept learning.</li>
                        <li>Explain forward and backward chaining. How are computer vision and AI related?</li>
                        <li>Define admissible heuristic and consistency. Prove the theorem "A*" is optimal if h(n) is admissible".</li>
                        <li>What are the properties of knowledge representation? Explain different approaches of knowledge representation.</li>
                        <li>Define conjunctive normal form (CNf) with suitable example. Prove that (p∧q) -> (p∨q) is a tautology.</li>
                        <li>Write short notes on: (any two) <br>
                            a. Fully observable vs. partially observable agent <br>
                            b. Map coloring problem  <br>
                            c. Hill climbing search <br>
                        </li>
                        ...
                        <li>How can you differentiate uninformed and heuristically informed search? Explain in detail about any two unformed search algorithms.</li>
                        <li>Define Alpha-Beta Pruning> Explain an alpha cutoff and beta cutoff in details.</li>
                        <li>a. What is fuzzy logic? Explain the term height, union, intersection and relative complement with examples.</li>
                        <li>b. Prove the following fuzzy logic properties with example. Assume value yourself. <br>
                            i. Double negatoin <br>
                            ii. De Morgan's law <br>
                        </li>
                    </ol>
                </div>
            </div>
