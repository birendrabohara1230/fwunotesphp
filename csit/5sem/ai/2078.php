        ...
        <div class="row justify-content-center">
            ...
            <div class="col-lg-8 col-11 text-center border shadow mb-4" id="paper-model">
                ...
                <div class="text-start">
                    <ol>
                       <li>What do you mean by forward chaining? Explain it with examples.</li>
                       <li>Justify that AI cannot exist without searching.</li>
                       <li>Define machine learning.</li>
                       <li>Define admissible heuristic and monotonicity.</li>
                       <li>How can you construct expert system?</li>
                       <li>Define fuzzy logic.</li>
                       <li>Prove that (p∧q) -> (p∨Q) is a tautology.</li>

                        <h5 class="text-center">Group B</h5>
                        <b>
                            <p class="text-center">Attempt any five questions. (Short questions) (5x8=40)</p>
                        </b>
                         <li>Do you agree "the development of Artificial Intelligence has had some negative effects on the society"? If you agree, list some of them and put your opinion in the support of development of Artificial Intelligence.</li>
                         <li>What is Turing Test in AI? Criticize the performance of the Turing Test to measure the intelligence of the maching.</li>
                         <li>DEfine quantifier. Explain different inference rule for quantifier.</li>
                         <li>Define natural language understanding. Explain different levels of knowledge used in laguage understanding.</li>
                         <li>What is an intelligent Agent? Explain different environment that AI can be used </li>
                         <li>How can you convert to conjunctive normal form? Explain all the steps with examples.</li>
                        <h5 class="text-center">Group C</h5>
                        <b>
                            <p class="text-center">Attempt any three questions. (Long questions)</p>
                        </b>
                        <li>Define Alpha-Beta Pruning? Explain an alpha cutoff and beta cutoff in detail?</li>
                        <li>Why is fuzzy logic useful? Define the term height, union, intersection, relative complement and bounded sum with examples.</li>
                        <li>Explain in detail about hill Climbing search and greedy best first search with practical examples.</li>
                        <li>Define learning. Why is learning frame work required? Explain about explanation based machine learning.</li>
                    </ol>
                </div>
            </div>
