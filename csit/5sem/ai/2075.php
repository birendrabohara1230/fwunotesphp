        ...
        <div class="row justify-content-center">
            ...
            <div class="col-lg-8 col-11 text-center border shadow mb-4" id="paper-model">
                ...
                <div class="text-start">
                    <ol>    
                        <li>Are you generally optimistic or pessimistic about future of artificial intelligence and its benefits for humanity? Should we be concerned about military and other armed robots?</li>
                        <li>What is an intelligent agent? Explain different environments that AI can be used.</li>
                        <li>What do you mean by forward chaining? Why it is required? Compare it with backward chaining.</li>
                        <li>Differentiate between natural language understanding (NLU) and natural language generating (NLG). Why we have to study natural language processing? Explain it.</li>
                        <li>Define expert system. Explain the stages of expert system development.</li>
                        <li>Give bayes rule, explain its uses with an example. Prove that 
                            <br>
                            (p -> r)  ∧ (q -> r) =  (p ∨ q) -> r
                        </li>
                        <li>Explain depth limit search. Prove the theorem: if h(n) is consistent, then the values of f(n) along the path are non-decreasing; where, h(n) is heuristic function and f(n) is estimated total cost of path through n to goal.</li>
                        <li>Assume A and B are two fuzzy subsets of X. If C = A∪B and D=A∩B then prove: 
                           <br>
                            a. D⊂C <br>
                            b. A⊂C and B ⊂ C <br>
                            c. D ⊂ A and D ⊂ B <br>
                        ...
                        <li>Explain universal instantiation and existential generalization in predicate calculus. Write minimax procedure and illustrate the method with the game of Tic-Tac-Toe.</li>
                        <li>Why fuzzy logic is useful? Explain the architecture of fuzzy logic. Define the term normal support, core, complement and bounded sum with examples.</li>
                        <li>Justify that AI cannot exist without searching. Explain in detail about any two types of informed search with practical examples.</li>
                    </ol>
                </div>
            </div>
