        ...
        <div class="row justify-content-center">
            ...
            <div class="col-lg-8 col-11 text-center border shadow mb-4" id="paper-model">
                ...
                <div class="text-start">
                    <ol>
                        <li>Define AI. Explain Turing Test Approach.</li>
                        <li>Prove that A* search is optimal if h(n) is admissible where h(n) is heuristic function.</li>
                        <li>What is knowledge representation system? Explain the properties of knowledge representation system.</li>
                        <li>Difference between the forward and backward chaining.</li>
                        <li>Define intelligent agent. Explain its types with suitable example.</li>
                        <li>Explain semantic network. Write its advantages and disadvantages.</li>
                        <li>KB = {(G∨H) -> (~J ∧ ~K), G} Prove that ~J can be inferred from above KB by using resolution.</li>
                        ...
                        <li>Define Alpha-Beta Pruning. Explain an alpha cutoff in detail.</li>
                        <li>Explain Hill Climbing search techniques with suitable example. What are the problems that may arise in Hill Climbing searching?</li>
                        <li>You are given two jugs, a 4-liters gallon one and a 3 liters gallon one. Neither have any measuing markers on it. There is a pump that can be used to fill the jugs with water. How can you get exactly (4,2) meaning that the 4-liters gallon jug contains 4 liters of water and 3-liters gallon jug contains 2-liters of water? Solve this problem with state space representation.</li>
                    </ol>
                </div>
            </div>
