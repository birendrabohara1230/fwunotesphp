        ...
        <div class="row justify-content-center">
            ...
            <div class="col-lg-8 col-11 text-center border shadow mb-4" id="paper-model">
                ...
                <div class="text-start">
                    <ol>
                        <li>Construct a Syntax Directed Translation scheme that translates arithmetic expressions from intfix into postfix notation. Show the application of your scheme to the string "3*4+5*2.</li>
                        <li>Discuss indetail about the role of lexical analyzer with the possible error recovery actions.</li>
                        <li>Where do we use operator precedence parsing techniques? Give the general precedence table for operating precedence parsing, considering all the generalized rules.</li>
                        <li>Explain various code optimization techniques.</li>
                        <li>Construct minimum state DFA'S for following regular expression. <br>
                            a) (a|b)*a(a|b) <br>
                            b) (a|b)*a(a|b)(a|b)
                        </li>
                        <li>Describe Peephole optimization technique used in code optimization of complier design. </li>
                        <li>Discuss generic issues in the design of code generation.</li>
                        <li>a. Describe local and loop optimization <br>
                            b. Eliminat left recursion from the following grammar and rewrite the grammar <br> 
                               S -> Aa|b <br>
                               A -> Ac| Sd | ε
                        </li>
                       ...
                       <li>Explain the phases of complier? And how the following statement will be translated into every phase. Position = initial + rate * 60 </li>
                       <li>Consider the following grammar <br>
                         S -> AS|b <br>
                         A -> SA | a <br>
                         Construct the SLR parse table for the grammar. Show the action of the parser for the input string "abab".
                    </li>
                    <li>What is three address code representations? Translate the expression (a*b)+(c*d)+(a*b*c) into <br>
                        a. Quadruples. <br>
                        b. Triples. <br>
                        c. Indirect triples. <br>
                    </li>
                    </ol>
                </div>
            </div>
