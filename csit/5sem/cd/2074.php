        ...
        <div class="row justify-content-center">
            ...
            <div class="col-lg-8 col-11 text-center border shadow mb-4" id="paper-model">
                ...
                <div class="text-start">
                    <ol>
                        <li>Write the rule to eliminate left recursion in a grammar. Eliminate the left recursion from the following grammar. <br>
                        S -> Aa | b <br>
                        A -> Ac | Sd | ε
                        </li>
                        <li>Describe the error recovery scheme in compiler design? </li>
                        <li>Evaluate the expression for the syntax directed definition (SDD) by annotated parse tree. " 3*5+4n"</li>
                        <li>Explain in detail about various issue in code generation with example.</li>
                        <li>What do you mean by three address code representation? With an example describe different type of three address code representation schemes.</li>
                        <li>Find FIRST and FOLLOW sets of the following grammar. <br>
                            E -> E + E | T <br>
                            T -> T * F | F <br>
                            F -> (E) | id <br>
                        </li>
                        <li>Discuss in detail about the role of lexical analyzer.</li>
                        <li>Show that intermediate code for the following code segment. <br>
                            While (i < 10) <br>
                            if(i%2 == 0) <br>
                                evensum = evensum + 1 <br>
                            else <br>
                                oddsum = oddsum + 1 <br>
                        </li>
                       ...
                       <li>a. Explain the phases of compiler with a neat diagram. Draw an oracle process Architecture diagram. <br>
                           b. Explain how the following statement will be translated into every phase position = initial + rate * 60 <br>
                        </li>
                    </ol>
                </div>
            </div>
