        ...
        <div class="row justify-content-center">
            ...
            <div class="col-lg-8 col-11 text-center border shadow mb-4" id="paper-model">
                ...
                <div class="text-start">
                    <ol>
                        <li>Draw the block diagram of language processing and describe the structure of compiler? (4+4)</li>
                        <li>Explain left recursion and show how it is eliminated. Eliminate the left recursion from the followng grammar? (3+5) <br>
                            E -> E + T | T <br>
                            T -> T * F | F <br>
                            F -> (E) | id <br>
                        </li>
                        <li>What is three address code. Explain with example quadruple, triples and indirect triples? (2+6)</li>
                        <li>Explain the role of parser. List and explain various types of error recovery strategies? (2+6)</li>
                        <li>What is syntax directed definition? Explain inherited and synthesized attributed? (3+5)</li>
                        <li>Explain NFA and DFA? Why they are useful in a complier desing. (3+5)</li>
                        <li>Wha is code generation? List out the main issue in the design of code generation and explain any one issue from them. (2+6)</li>
                        <li>Write short notes on (2+2+2+2)
                            a) DAG <br>
                            b) Dead code elimination <br>
                            c) Predictive parsing <br>
                            d) Token and Pattern <br>
                        </li>
                        <h5 class="text-center">Group C</h5>
                        <b>
                            <p class="text-center">Attempt any two questions. (long questions) (2x16=32)</p>
                        </b>
                        <li>a) Explain briefly different storage allocation strategies? <br>
                            b) Explain any five techniques of code optimization used in compiler design? 
                        </li>
                        <li>Explain the various phase of compiler design with block diagram?</li>
                        <li>What is LR parsing? Draw a SLR parsing table for the following grammar. <br>
                            E -> E * B| E + B | B <br>
                            B -> 0 | 1 <br>
                        </li>
                    </ol>
