        ...
        <div class="row justify-content-center">
            ...
            <div class="col-lg-8 col-11 text-center border shadow mb-4" id="paper-model">
                ...
                <div class="text-start">
                    <ol>
                        <li>Why regular expression used in token specification? Write the regular expression to specify the identifier line in C language.</li>
                        <li>Consider the grammar: S -> SbS|bSaS|ε <br>
                            a) Show that the grammar is ambiguous by constructing two different leftmost and rightmost derivation for sentence "abab". <br>
                            b) Construct the corresponding parse tree for both derivation.
                        </li>
                        <li>What do you mean by S-attributed definition and how they are evaluated? Explain with example.</li>
                        <li>What do you mean by three address code representation? Write a three address code for the expression "r=7*3+9" and represent this three address code in quadruple design.</li>
                        <li>Explain the role of parser. Describe non recursive predictive parsing techniques.</li>
                        <li>Explain about peephole optimization and dead code optimization with example.</li>
                        <li>What are the different issues in the design of code generator? Explain each briefly.</li>
                        <li>Find first and follow function of following grammar: <br>
                            S -> CC <br>
                            C -> bc|d
                        </li>
                        ...
                        <b>
                         ...
                         <li>Explain the various phases of compiler design in detail with practical example.</li>
                         <li>Construct SLR parsing table of the following grammar also trace the parsing for input string aa+a* <br>
                            S -> SS+ <br>
                            S -> SS* <br>
                            S - a <br>
                         </li>
                         <li>What do you mean by code optimization? Explain the basic block optimization with example.</li>
                    </ol>
                </div>
            </div>
