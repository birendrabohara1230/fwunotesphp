        ...
        <div class="row justify-content-center">
            ...
            <div class="col-lg-8 col-11 text-center border shadow mb-4" id="paper-model">
                ...
                <div class="text-start">
                    <ol>
                        <li>Wha is computer graphics, explain application area of computer graphics and list out input devices.</li>
                        <li>What is OpenGL, explain basic syntax of OpenGL and explain display window management using GLUT.</li>
                        <li>Explain 2D translation and write homogenous matrix equation for translation and find the new points of square A(0,0), B(4,0), C(4,4) and D(0,2) after translating the square by 3 uints in both directions.</li>
                        <li>Explain area sub division method with figure and write the two approaches used for visible surface detection methods.</li>
                        <li>What is rendering, explain the terms point light source, distribution ligth source and diffuse reflection.</li>
                        <li>Write equation of circle and explain the circle drawing mid-point algorithm.</li>
                        <li>Write a program in C to draw a circle and write any four properties of circle.</li>
                        <li>What is clipping? Explain the term point clipping, line clipping and find out list from the following figure. <br>
                        <img src="../../../images/cg8.png" alt="" class="img-fluid">
                        </li>
                        <h5 class="text-center">Group C</h5>
                        <b>
                            <p class="text-center">Attempt any two questions. (long questions) (2x16=32)</p>
                        </b>
                       <li>Explain CRT operation and explain the Raster Scan, Random Scan (vector Scan), beam penetration method and the shadow-mask method.</li>
                       <li>WRite equation of line and explain the DDA algorithm and write a program in C to draw a line.</li>
                       <li>Explain 2D rotation and scaling and write homogenous matrix equation for both rotation and scaling. Find the new points of a triangle A(0,0), B(5,0) and C(2,2) after rotating the triangle by 90 degree.</li>
                    </ol>
                </div>
            </div>
