        ...
        <div class="row justify-content-center">
            ...
            <div class="col-lg-8 col-11 text-center border shadow mb-4" id="paper-model">
                ...
                <div class="text-start">
                    <ol>
                        <li>What are components of computer graphics and explain the term frame buffer and beam penetraton method.</li>
                        <li>Explain OpenGL and OpenGL libraries used and explain error handling in OpenGL.</li>
                        <li>Write short notes on Depth sorting Method, and ray casting method.</li>
                        <li>Explain back free face detection method and A-buffer method.</li>
                        <li>What is illumination, writer short notes on Constant Intensity Shading (Flat Shading) and interpolated shading?</li>
                        <li>Explain DDA algorithm.</li>
                        <li>Write a program in C to draw a line and explain the equation of line.</li>
                        <li>Write in short the 2D translation and rotation with matrix equation.</li>
                        <h5 class="text-center">Group C</h5>
                        <b>
                            <p class="text-center">Attempt any two questions. (long questions) (2x16=32)</p>
                        </b>
                        <li>Explain difference between Raster Scan, Random Scan(Vector Scan) and explain different applicatoin areas of computer graphics and explain mid point circle drawing algorithm in short.</li>
                        <li>Explain visible surface detection method with different approaches used and write short notes on area sub-division method, depth buffer method and write a program in C to draw a circle with center at (200, 200).</li>
                        <li>Explain different 2D geometric transformation with matrix equations. Find the transformation matrix that transforms the square ABCD whose center is at (2,2) is reduced to half of its size with center still remaining at (2,2), the coordinate of square are ABCD are A(0,0), B(0,4), C(4,4), and D(4,0).</li>
                    </ol>
                </div>
            </div>
