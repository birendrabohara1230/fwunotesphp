        ...
        <div class="row justify-content-center">
            ...
            <div class="col-lg-8 col-11 text-center border shadow mb-4" id="paper-model">
                ...
                <div class="text-start">
                    <ol>
                       <li>Explain the term frame buffer.</li>
                       <li>What is Open GL? Explain some basic syntax.</li>
                       <li>Write short notes on 2D translation.</li>
                       <li>Write short notes on window and viewport with pictorial representation.</li>
                       <li>What are the two approaches used in visible surface detection methods?</li>
                       <li>Explain the ambient light illumination model in short.</li>
                       <li>What is rendering?</li>
                       <li>What is ray casting method? Expalin in short.</li>
                        <h5 class="text-center">Group B</h5>
                        <b>
                            <p class="text-center">Attempt any five questions. (Short questions) (5x8=40)</p>
                        </b>
                        <li>What are the five routings necessary to initialize a window in OpenGL?</li>
                        <li>Explain Sutherland-Hodgman poygon clipping with example.</li>
                        <li>What is depth buffer method? Explain its steps.</li>
                        <li>Explain phong shading.</li>
                        <li>What are components of computer graphics? Explain any three computer graphics applicatoin areas.</li>

                        <h5 class="text-center">Group C</h5>
                        <b>
                            <p class="text-center">Attempt any three questions. (Long questions) (3x12=36)</p>
                        </b>
                        <li>Explain the mid-point circle drawing algorithm and find the points in the circle for given center at (2,9).</li>
                        <li>What are homogenous matrix representations for basic geometric transformation? Find the new points of polygon A(2,5), B(7,10) and C(10,2) after moving by 3 units in x direction and 2 units in Y direction.</li>
                        <li>Explain difference between randon scan and raster scan. Write a program in C to draw a line for given two end point A(1,3) and B(11,3).</li>
                        <li>Describe the architecture of raster scan display. Also define window, viewport and viewing transformation with example.</li>
                    </ol>
                </div>
            </div>
