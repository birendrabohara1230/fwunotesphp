        ...
        <div class="row justify-content-center">
            ...
            <div class="col-lg-8 col-11 text-center border shadow mb-4" id="paper-model">
                ...
                <div class="text-start">
                    <ol>
                        <li>What is computer graphics? Explain applications areas of computer graphics.</li>
                        <li>Explain OpenGL and OpenGL headers used and explain error handing in OPenGL.</li>
                        <li>Write short note on Bresenbam's lne drawing algorithm.</li>
                        <li>What are different geometric transformations and explain translation in 2D 
                            transformation.
                        </li>
                        <li>Explain the depth buffer method in short.</li>
                        <li>Explain two polygon rendering methods in short.</li>
                        <li>Write a program in C to draw a rectange.</li>
                        ...
                        <li>Write short notes on Cohen-Sutherland line clipping, Window-to-Viewport coordinate transformation, A-Buffer method and ray casting.</li>
                        <li>What is rendering? Explain different light sources and explain the two illuminatino models in details.</li>
                        <li>What is clipping, explain different applicatoin areas of clipping and explain the point
                            and line clipping procedure. Find the transformation matrix that transforms the square ABCD 
                            whose center is at (3,3) is enlarged to twice its size with center still remaining at (3,3), the co-ordinates of square are ABCE are A(0,0), B(0,5), C(5,5) and D(5,1).
                        </li>
                    </ol>
                </div>
            </div>
