        ...
        <div class="row justify-content-center">
            ...
            <div class="col-lg-8 col-11 text-center border shadow mb-4" id="paper-model">
                ...
                <div class="text-start">
                    <ol>
                        <li>Define random number and pseudo number. Explain tthe rejection method for random number
                            generation</li>
                        <li>What is general purpose simulation system (GPSS)? Explain any 5 GPSS symbols with their
                            meaning.</li>
                        <li>Define system with characteristics? List out entities, attributes, activities and state for
                            the traffic, bank, communication system.</li>
                        <li>Explain the process of model validation through the iterative method of calibration.</li>
                        <li>Define queuing system with examples. Explain characteristics of queuing system.</li>
                        <li>What is simulation model? Explain physical mathematical model with examples.</li>
                        <li>Write when simulation is appropriate tool and when not.</li>
                        <li>Describe principles used in modeling.</li>
                        ...
                        <li>What is simulation study? Explain the various steps used in simulation study.</li>
                        <li>Describe the properties of random numbers. Explain kolmogorov- simnov test. The sequence of
                            numbers 0.54,0.73,0.98,0.11 and 0.68 has been generated. Use k-s &#x0251;=0.05 test to
                            determine if the hypothesis that the numbers are uniformly distributed on the interval 0 to
                            1 can be rejected.</li>
                        <li>Write short note on following <br>
                            a) Linear congruential method <br>
                            b) Kendall <br>
                            c) Static Model <br>
