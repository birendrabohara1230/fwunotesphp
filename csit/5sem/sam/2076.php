        ...
        <div class="row justify-content-center">
            ...
            <div class="col-lg-8 col-11 text-center border shadow mb-4" id="paper-model">
                ...
                <div class="text-start">
                    <li>Define system, system environement and component of system with examples.</li>
                    <li>Write advantages and disadvantages of simulation.</li>
                    <li>Describe Queuing system. Explain call center problem.</li>
                    <li>What factor should be considered to select simulation software? Describe any four GPSS building
                        blocks with proper meaning.</li>
                    <li>By defining random number with their property, explain inverse transform technique for uniform
                        and triangular distributions.</li>
                    <li>Define discrete event simulation. Describe time advance algorithm.</li>
                    <li>Explain various characterisstics of queuing system.</li>
                    <li>Use the multiplicative congruential method to generate a sequence of four three digit random
                        number let X<sub>0</sub>=118, a=4 and m=1000.</li>

                   <h5 class="text-center">Group C</h5>
                    <b>
                        <p class="text-center">Attempt any two questions. (2x16=32)</p>
                    </b>
                    <li>What is pseudo random number? The sequence of numbers 0.54,0.73,0.97,0.10 and 0.67 has been
                        generated. Use k-s test &#x0251;=0.5 to determine if the hypothesis that numbers are uniformly
                        distributed on the interval [0,1] can be rejected.</li>
                    <li>Explain various steps performed for simulation study with flow chart.</li>
                    <li>Describe various application areas of simulation.</li>
