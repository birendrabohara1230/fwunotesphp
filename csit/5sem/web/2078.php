...
<head>
    ...
    <title>Web Technology I (CSIT.316)</title>
        ...
        <div class="row justify-content-center">
            ...
            <div class="col-lg-8 col-11 text-center border shadow mb-4" id="paper-model">
                ...
                <div class="text-start">
                    <ol>
                        <li>Write the structure of HTTP requrest and response message.</li>
                        <li>How will you create a password field in a HTML form?</li>
                        <li>What is #PCDATA?</li>
                        <li>Why has javascript been called dynamically typed language?</li>
                        <li>How do you create Array in javascript?</li>
                        <li> Define selectors in CSS.</li>
                        <li>HOw do you add background image and colour in your web page.</li>
                        <li>Define Web 2.0.</li>
                        <h5 class="text-center">Group B</h5>
                        <b>
                            <p class="text-center">Attempt any five questions. (Short questions) (5x8=40)</p>
                        </b>
                        <li>Describe the structure of HTML in bried. Also mention the use ofrowspan and colspan in table. </li>
                        <li>What are the uses and mis uses of Internet In your opinions? Explain in brief.</li>
                        <li>Explain any four javascript array methods with syntax and example.</li>
                        <li>Define regular expression. Write a javascript code to validate Email address.</li>
                        <li>Wht is DTD? Explain the creation of external DTD with example.</li>
                        <li>Write short notes on (any two)
                            <ol type="a">
                                <li>JavaScript Cookies</li>
                                <li>Advantage of XML.</li>
                                <li>XML DOM</li>
                            </ol>
                        </li>
                       ...
                       <li>Briefly explain the various types of dialogue boxes in Javascript with example.</li>
                       <li>Define XML schema. What are the rules of writing XML? Generate the XML and XML schema for the given
                         problem. Create a root element say class with child student and student have further three child Fname, Lname, and age where Fname and Lname must be string type and age should be integer. And should be in proper sequence also? 
                       </li>
                       <li>Describe the importance of CSS. Explain internal and external CSS with suitable example.</li>
                       <li> Write a complete javascript program to find sum of two numbers using <b>getElementById()</b>
                          method as given below. Result should be displayed when click on SUM button. <br>
                          <label for="a" style="margin-right: 23px;">Enter first Number:</label> <input type="text" id="a"> <br> <br>
                          <label for="b">Enter second Number:</label> <input type="text" id="b"> <br> <br>
                          <button type="button" style="margin-right: 105px;">SUM</button> <input type="text">
                    </li>
                    </ol>
                </div>
            </div>
            <div class="col-lg-3 col-11 shadow mb-4 costume-shadow" id="paper-fourth-sem">
                ...
                <ol>
                    ...
                    <li><a href="#">Web Technology I</a></li>
                </ol>
            </div>
        </div>
    </div>
