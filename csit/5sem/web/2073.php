        ...
        <div class="row justify-content-center">
            ...
            <div class="col-lg-8 col-11 text-center border shadow mb-4" id="paper-model">
                ...
                <div class="text-start">
                    <ol>
                         <li>How can you create a table in HTML? Discuss with example.</li>
                         <li>Wrie a HTML code to display the following statements (A+B)<sup>2</sup>=a<sup>2</sup>+2ab+b<sup>2</sup></li>
                         <li>What is DTD? Explain public DTD with example.</li>
                         <li>What are the advantages of using javascript? Write a javascript code to find sum of two numbers entered by users.</li>
                         <li>Explain different types of list tags with example in HTML.</li>
                         <LI>Write down syntax rules for writing XML?</LI>
                         <li>What are the uses of HTML? Describe following tags with example. <br>
                            <ol type="a">
                                <li>Marquee</li>
                                <li>Scrip</li>
                            </ol>
                        </li>
                        <li>What is XML? Explain its uses in brief.</li>

                        <h5 class="text-center">Group C</h5>
                        <b>
                            <p class="text-center">Attempt any two questions. (very long questions) (2x16=32)</p>
                        </b>
                        <li>Explain prompt, alert and confirm dialog boxed in javascript with example.</li>
                        <li>Develop a simple website that asks the user id and password and email to the user and write a code to validate these fields.</li>
                        <li>DEfine CSS? Explain different types of CSS with example.</li>
                    </ol>
                </div>
            </div>
