        ...
        <div class="row justify-content-center">
            ...
            <div class="col-lg-8 col-11 text-center border shadow mb-4" id="paper-model">
                ...
                <div class="text-start">
                    <ol>
                        <li>Why is XML namespace significance?</li>
                        <li>How many types of heading does an HTML contain?</li>
                        <li>What is RWD (Responsive Web Page Design)?</li>
                        <li>What is the Box Model in CSS?</li>
                        <li>What is DOM? What is the use of document object?</li>
                        <li>How to create objects in JavaScript?</li>
                        <li>What is a well formed XML document?</li>
                        <li>Define web server.</li>
                        <h5 class="text-center">Group B</h5>
                        <b>
                            <p class="text-center">Attempt any five questions. (Short questions) (5x8=40)</p>
                        </b>
                        <li>How do you use external CSS file in the webpage?</li>
                        <li>Describe HTTP with its header fields and functions.</li>
                        <li>Write javascript code to valide mobile number and email address.</li>
                        <li>Differentiate between DTD and XML schema. Also mention the features of XML.</li>
                        <li>What is HTML link? Explain different link used in html.</li>
                        <li>Explain ordered and unorderd list in HTML with its significance.</li>
                        <h5 class="text-center">Group C</h5>
                        <b>
                            <p class="text-center">Attempt any three questions. (Long questions) (3x12=36)</p>
                        </b>
                        <li>What are the advantages of using CSS in Web pages? what are the different types of Selection
                            in CSS?</li>
                        <li> Whare the pop-up boxes avaiblae in JavaScript? Illustrate with programming example.</li>
                        <li>Whare the rules for writting XML? Write an XML schema to describe "address" as an element
                            and "city, state, street and house-no" as its attributes.</li>
                        <li>Explain regular expression with their meaning. Develop java script program to solve given
                            problem. Input two numbers using getElementById and add them and display result using the
                            alert box.</li>
                    </ol>
                </div>
            </div>
