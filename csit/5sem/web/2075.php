        ...
        <div class="row justify-content-center">
            ...
            <div class="col-lg-8 col-11 text-center border shadow mb-4" id="paper-model">
                ...
                <div class="text-start">
                    <ol>
                        <li>What are the uses and misuses of internet in our society?</li>
                        <li>Write a javascript function to add two numbers entered by user.</li>
                        <li>What is Form validation? HOw do you validate email id of a person in javascript?</li>
                        <li>What are the rules for writing XML? Explain with example.</li>
                        <li>Create a XML document to store Voter Id, voter name, address and date of birth details. Create a DTD to validate the document.</li>
                        <li>How do insert external CSS into HTML file? Explain.</li>
                        <li>Wha is HTTP? Discuss its function in detail.</li>
                        <li>Describe following HTML tags with example <br>
                            a. DIV and SPAN  <br>
                            b. MARQUEE
                        </li>
                        ...
                        <li>Describe the structure of XML schema. Explain XSD order indicator and occurrence indicator with example.</li>
                        <li>Explain javascript popup boxes prompt and confirm with example.</li>
                        <li>Describe various types of list in HTML with example. Write HTML code to illustrate the usage of nesting  of tags. <br>
                            <ol>
                                <li>SCIENCE</li>
                                <ol type="a">
                                    <li>BIOLOGY</li>
