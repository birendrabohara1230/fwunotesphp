        ...
        <div class="row justify-content-center">
            ...
            <div class="col-lg-8 col-11 text-center border shadow mb-4" id="paper-model">
                ...
                <div class="text-start">
                    <ol>
                        <li>Writ a program using javascript to enter the two numbers and display the sum of numbers.</li>
                        <li>Define HTML. Explain html frames with example.</li>
                        <li>What is hyperlink? Explain its types with example.</li>
                        <li>Discuss the importance of Internet and also mention positive and negative impacts of social media.</li>
                        <li>What is pattern matching? Describe the meta charactes (\d\D\w\W\s\S).</li>
                        <li>What is exception handing? Explain the term try, catch and finally with example.</li>
                        <li>Describe all Indicators and occurrence indicators in XML with example.</li>
                        <LI>Write short notes on: (any two) <br>
                            <ol type="a">
                                <li>List tag in html</li>
                        ...
                        <li>DEfine pop up box in javascript. Explain various popup boxes with example.</li>
                        <li>a. Define CSS. Explain external CSS with example. <br>
                            b. What is XML schema? Explain any three XML restriction with example. </li>
                        <li>What is form validation? Validate First name and Email Id of student in javascript. First name must contain alphabets only and Email id should be valid as usual.</li>
                    </ol>
                </div>
            </div>
