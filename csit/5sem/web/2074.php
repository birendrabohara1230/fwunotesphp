        ...
        <div class="row justify-content-center">
            ...
            <div class="col-lg-8 col-11 text-center border shadow mb-4" id="paper-model">
                ...
                <div class="text-start">
                    <ol>
                        <li>What is frame in HTML? Explain with example.</li>
                        <li>Define XML. Write down syntax rules for writing XML and the uses of XML?</li>
                        <li>Write a javascript program to add two integer numbers using function.</li>
                        <li>What is pattern matching? Explain the meaning of \d,\D,\s,\S,\w and \W characters with example.</li>
                        <li>Write an XML file which will display the Book information. It includes information such as Titile of the book, Author Name, ISBN number, Publisher name, Edition, Price, etc. <br>
                        Write a Document Type Definitino (DTD) to validate the above XML flie.
                        </li>
                        <li>What is exception handling? Explain with example.</li>
                        <li>Describe XML simple data type and complex data type with example.</li>
                        <li>Explain basic HTML tag: meta tags, marquee and link tag with example.</li>

                        <h5 class="text-center">Group C</h5>
                        <b>
                            <p class="text-center">Attempt any two questions. (very long questions) (2x16=32)</p>
                        </b>
                        <li>Explain prompt, alert and confirm dialog box in javascript with syntax and example.</li>
                        <li>Define CSS. Explain various types of CSS with example of your choice.</li>
                        <li>The name should be entered using prompt and name should in the format firstname and lastname. The firstname and lastname should not more than 15 charactes. There should be single white space between firstname and lastname. Write a javascript code to valide name and if invalid name entered, display proper message.</li>
                    </ol>
                </div>
            </div>
