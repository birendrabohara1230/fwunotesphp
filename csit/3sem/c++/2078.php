...
<head>
    ...
    <title>Object oriented programming (CSIT.214)</title>
    ...
    <div class="container" id="paper-container">
        <div class="row justify-content-center">
            ...
            <div class="col-lg-8 col-11 text-center border shadow mb-4" id="paper-model">
                ...
                <p>Object oriented programming (CSIT.214)</p>
                ...
                <div class="text-start">
                    <ol>
                        ...
                        <li>Define data abstraction in oops.</li>
                        <li>Define default argument with example.</li>
                        <li>Which operators can not be overloading in C++?</li>
                        <li>What is pure virtual function?</li>
                        <li>What is namespace? Give an example.</li>
                        <li>List any two differences between class and objects.</li>
                        <li>what is container class?</li>
                        <!-- Group B -->
                        ...
                        <!-- Group B -->
                        <li>What is inline function?Write a program to calculate cube of a number?. </li>
                        <li>What is template? WAP to add two numbers using concepts of template..</li>
                        <li>How do you convert one .class type to another class type? Write a c++ program to convert
                            degree to radian using the concept of class yo -class type conversion.</li>
                        <li>What is exception? Explain the mechanism of exception handling? </li>
                        <li>What is dyamic memory allocation? Write a program to add to string using dynamic constructor
                            concepts. </li>
                        <li>Define virtual function with suitable example. </li>
                        <!-- Group C-->
                        ...
                        <!-- Group C -->
                        <li>What are the limitation of procedure-oriented programming?mention the features of oops with
                            example.
                        </li>
                        <li>What are the rules of operator overloading? create a class called complex with data member
                            real and imaginary. use necessary
                            function and write a program to overload binary plus (+)to add two complex numbers and
                            display result.
                        </li>
                        <li>Explain the need of inheritance in programming?write syntax and structure of single ,
                            multiple and multilevel inheritance. illustrate virtual base class concepts with diagram and
                            syntax only.
                        </li>
                        <li>Define construction? Explain the types of construction with example.
                        </li>
                    </ol>
                </div>
            </div>
