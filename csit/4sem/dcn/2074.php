...
<head>
    ...
    <title>Data Communication and Networking (CSIT.222)</title>
    ...
    <div class="container" id="paper-container">
        <div class="row justify-content-center">
            ...
            <div class="col-lg-8 col-11 text-center border shadow mb-4" id="paper-model">
                ...
                <p> Data Communication and Networking (CSIT.222)</p>
                ...
                <h5>Group B</h5>
                <b>
                    <p>Attempt any six questions.(6x8=48) (Short questions)</p>
                </b>
                <div class="text-start">
                    <ol>
                    <li>Explain access protocols CSMA/CD snd Token passing in brief.</li>
                    <li>Explain LLC layer and write short note on function of router.</li>
                    <li>Write short notes on error detection methods.</li>
                    <li>Explain any of the two multiplexing methods in short.</li>
                    <li>Explain internet protocols stack and explain MAC in short.</li>
                    <li>Explain serial and parallel transmission with their advantages and disadvantages.</li>
                    <li>What is the different between centralized and distributed data processing?</li>
                    <li>Define band width, through, latency and protocols.</li>

                     <h5 class="text-center">Group C</h5>
                     <b>
                         <p class="text-center">Attempt any two questions. (2x16=32) (Long questions)</p>
                     </b>
                     <li>Explain the TCP header and IP header in detail. Also briefly explain about the network perforance factors.</li>
                     <li>Write in short IPV4 and IPV6, find number of subnets, block size, valid subnets, total hosts per subnet, and valid hosts per subnet, broadcast address and network address of each subnet for given IP 192.168.0.12/26.</li>
                     <li>Explain different flow control techniques and HDLC operation in detail.</li>
                    </ol>
             </div>
         </div>
         <div class="col-lg-3 col-11 shadow mb-4" id="paper-fourth-sem">
             <h4>Fourth Semester</h4>
             <ol>
                 <li><a href="../sad/2075.php">System Analysis and Design</a></li>
                 ...
                 <li><a href="#">Data Communication and Networks</a></li>
