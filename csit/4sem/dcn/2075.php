        ...
        <div class="row justify-content-center">
            ...
            <div class="col-lg-8 col-11 text-center border shadow mb-4" id="paper-model">
                ...
                <div class="text-start">
                    <ol>
                     <li>What is data communication? Explain with its components.</li>         
                     <li>Explain the two different transmission modes with their advantages and disadvantages in short.</li>
                     <li>Explain packet switching approach with its pros and cons.</li>
                     <li>Explain different IP support protocols in short.</li>
                     <li>What is transmission impairment?, explain its different types.</li>
                     <li>Explain IPV4 packet header in short.</li>
                     <li>Explain in different data encoding methods.</li>
                     <li>Explain different error detection methods with example.</li>

                     <h5 class="text-center">Group C</h5>
                     <b>
                         <p class="text-center">Attempt any two questions. (2x16=32) (Long questions)</p>
                     </b>
                    <li>Why do we need network models? Explain the two standard network models used in detail.</li>
                    <li>Explain different computer address, find number of subnets, block size, valid subnets, total hosts per subnets, and valid hosts per subnet, broadcast address and network address of each subnet for given IP 192.168.1.0/26</li>
                    <li>Explain the concept and important of multiplexing with different methods of multiplexing.</li>
                 </ol>
             </div>
         </div>
