...
<head>
    ...
    <title> System Analysis and Design (CSIT.225)</title>
    ...
    <div class="container" id="paper-container">
        <div class="row justify-content-center">
            ...
            <div class="col-lg-8 col-11 text-center border shadow mb-4" id="paper-model">
                ...
                <p> System Analysis and Design (CSIT.225)</p>
                ...
                <div class="text-start">
                    <ol>
                        <li>What is information system? explain types of information system.</li>
                        <li>Who is system analyst? Highlight the major characteristics of a good system analyst.</li>
                        <li>Define capability maturity model. Explain its different levels.</li>
                        <li>Explain waterfall model with advantages and disadvantages.</li>
                        <li>Describe creeping commitment approach for feasibility analysis. Explain different
                            checkpoints of creeping commitment approach.</li>
                        <li>Explain about process modeling and process decomposition.</li>
                        <li>What short notes on: (any two) <br>
                            a) pay-back analysis <br>
                            b) Return on investment analysis <br>
                            c) CASE tools
                        </li>
                        ...
                        <li>What is SDLC? Explain its different stages with block diagram</li>
                        <li>What is project management? What causes the project failure? Explain different tools and
                            techniques of project management.</li>
                        <li>What do you mean by fact finding technique? Explain different fact finding techniques with
            ...
            <div class="col-lg-3 col-11 shadow mb-4" id="paper-fourth-sem">
                ...
                <ol>
                    ...
                    <li><a href="../dcn/2074.php">Data Communication and Networks</a></li>
