...
<head>
    ...
    <title>Advanced Java Programming (CSIT. 412)</title>
    ...
    <div class="container" id="paper-container">
        <div class="row justify-content-center">
            ...
            <div class="col-lg-8 col-11 text-center border shadow mb-4" id="paper-model">
                ...
                <p>Advanced Java Programming (CSIT. 412)</p>
                ...
                <div class="text-start">
                    <ol>
                        <li>What is RMI? Discuss architecture of RMI in detail.</li>
                        <li>What is socket? How can you communicate two programs in a network using TCP socket?</li>
                        <li>What is Servlet? Discuss life cycle of servlet in detail.</li>
                        <li>Discuss the process of creating menu in java with example.</li>
                        <li>What are the features of swing? Differentiate between AWT and java Swing.</li>
                        <li>What is JDBC? Explain various type of JDBC drivers, also explain major design constraints
                            with JDBC.</li>
                        ...
                        <li>Define Layout manager. Explain any two layout manager with example. </li>
                        <li>Design a GUI program to add two numbers. Use text field to input data and create necessay
                            button also. Display the sum when user click on button "result".</li>
                        <li>Develop an application to accept a String and perform following functions. <br>
                            a. Find length of the string. <br>
                            b. Find no of words in it determine whether the string is palindrome or not <br>
                            c. Find number of vowels in it <br>
                            d. All output to be displayed using JOptionPane. <br>
                        </li>
                    </ol>
                </div>
            </div>
            <div class="col-lg-3 col-11 shadow mb-4 costume-shadow" id="paper-fourth-sem">
                ...
                <ol>
                    ...
                    <li><a href="#">Advanced Java Programming</a></li>
                    <li><a href="../ooad/2075.php">Object Oriented Analysis and Design</a></li>
                    <li><a href="#">Minor Project II</a></li>
                    <li><a href="../dba/2074.php">Database Administration (Elective I)</a></li>
