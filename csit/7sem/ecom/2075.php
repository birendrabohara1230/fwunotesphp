...
<head>
    ...
    <title>E-commerce (CSIT. 411)</title>
        ...
        <div class="row justify-content-center">
            ...
            <div class="col-lg-8 col-11 text-center border shadow mb-4" id="paper-model">
                ...
                <div class="text-start">
                    <ol>
                        <li>Why do we need smart cards? Discuss.</li>
                        <li>Explain the uses of E-business application and their pitfalls with reference to the present needs of the organizations.</li>
                        <li>Define home banking. Explain the services of home banking.</li>
                        <li>Explain economic right of ecommerce in context of Nepal.</li>
                        <li>Explain the scope of ecommerce in today's world.</li>
                        <li>What are the advantages of doing business on the internet? Explain.</li>
                        <li>What are the different factors that affect consumer behavior model?</li>
                        <li>Who employ local marketing? Explain the advantages and disadvantages of local marketing.</li>

                        <h5 class="text-center">Group C</h5>
                        <b>
                            <p class="text-center">Attempt any two questions. (very long questions) (2x16=32)</p>
                        </b>
                        <li>What is EDI envelpe for message? Explain the architecture of EDI in detail.</li>
                        <li>What type of electronic payment systems are required in E-commerce? Why are there different types of payment system?
                            Explain the necessary characteristics of each type of payment system and given an example of each where it is used.
                        </li>
                        <li>Elaborately explain how to establish trust in e-commerce.</li>
