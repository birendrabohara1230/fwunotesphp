...
<head>
    ...
    <title>Database Administration (CSIT. 415.2)</title>
    ...
    <div class="container" id="paper-container">
        <div class="row justify-content-center">
            ...
            <div class="col-lg-8 col-11 text-center border shadow mb-4" id="paper-model">
                ...
                <p>Database Administration (CSIT. 415.2)</p>
                ...
                <div class="text-start">
                    <ol>
                        <li>What is main difference between a databse and instance of database. Explain the relation between them?</li>
                        <li>Explain the overall oracle database Architecture?</li>
                        <li>Explain Background process of oracle database architecture with example?</li>
                        <li>Explain use of DML operatoin in a database table with suitable example?</li>
                        <li>Explain oracle managed files (OMF) used in oracle database?</li>
                        <li>Why database security and authorization is required in oracle database explain it?</li>
                        <li>Write PL/SQL query to perform the following tasks? 
                            <br>
                            a. Create a table for the attributes Teacher(T_name, T_address, T_id, T_dept_no) and department(D_id, D_name)?
                            <br>
                            b. Display the name of teacher who belongs to departments science and Management?
                        </li>
                        <li>Write short notes on <br>
                            a. SGA <br>
                            b. SMON <br>
                        </li>
                        ...
                        <li>What are SQL tuning. Describe basic steps of tuning and goals for Tunning is SQL/</li>
                        <li>What do you mean by recovery process in oracle database. Explain RMAN database recovery while the database block in 
                            corrupted? 
                        </li>
                        <li>What is DBA. Explain the main role and responsibility of DBA in oracle database?</li>
                    </ol>
                </div>
            </div>
            <div class="col-lg-3 col-11 shadow mb-4 costume-shadow" id="paper-fourth-sem">
                ...
                <ol>
                    <li><a href="../ecom/2075.php">E-commerce</a></li>
                    <li><a href="../adJava/2075.php">Advanced Java Programming</a></li>
                    <li><a href="../ooad/2075.php">Object Oriented Analysis and Design</a></li>
                    <li><a href="#">Minor Project II</a></li>
                    <li><a href="#">Database Administration (Elective I)</a></li>
                    <li><a href="../dmw/2075.php">Data Mining and Warehousing (Elective II)</a></li>
                </ol>
            </div>
        </div>
    </div>
