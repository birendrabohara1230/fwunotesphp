        ...
        <div class="row justify-content-center">
            ...
            <div class="col-lg-8 col-11 text-center border shadow mb-4" id="paper-model">
                ...
                <div class="text-start">
                    <ol>
                        <LI>What are the consitutes of an oracle database? Explain each of them.</LI>
                        <li>What do you mean by Automatic Storage Management (ASM)? Explain its benefits. </li>
                        <li>Which architecture should Oracle Enterprise Manger use? Explain the function of each component of architecture.</li>
                        <li>What is a User Account and also explain the System Predefined User Roles?</li>
                        <li>Give the name of two methods for performing Oracle backup and recovery. Explain Recovery Manager (RMAN) method.</li>
                        <li>What is Data Pump Import? Explain Data Pump import Modes.</li>
                        <li>What would be the main responsibiliites of oracle DBA in organization?</li>
                        <li>Explain some difference between Oracle DBA role and Oracle Developer role.</li>
                        <li>Write Short notes on <br>
                            a. PGA <br>
                            b. Oracle Managed Files (OMF) <br>
                        </li>
                        ...
                        <li>Explain in detail different types of Errors and Failures occures in oracle database Recovery.</li>
                        <li>What is Oracle Database Memory Management? Describe three type of memory management scheme used in oracle database
                            memory management?
                        </li>
                        <li>Explain Oracle Process Architecture with block diagram?</li>
                    </ol>
                </div>
            </div>
