...
<head>
    ...
    <title>Data Mining and Warehousing (CSIT.416.1)</title>
    ...
    <div class="container" id="paper-container">
        <div class="row justify-content-center">
            ...
            <div class="col-lg-8 col-11 text-center border shadow mb-4" id="paper-model">
                ...
                <p>Data Mining and Warehousing (CSIT.416.1)</p>
                ...
                <div class="text-start">
                    <ol>
                        <LI>Explain difference between KDD and Data Mining with definition.</LI>
                        <li>Explain in short Data Mining Task Primitives.</li>
                        <li>What is data warehouse, explain different features of data warehouse.</li>
                        <li>Explain is multidimensional data model and data cube.</li>
                        <li>What is Meta data? Explain different data warehouse backend tools and utilites.</li>
                        <li>What is classification? Explain comparison of classification and prediction methods.</li>
                        <li>Explain Naive Bays classification.</li>
                        <li>What is regression? Explain in short linear regression.</li>
                        ...
                        <li>Explain major task in data processing and explain in short different data mining application areas.</li>
                        <li>Why do we need a separate data warehouse? Explain difference between Operational Database System (OLTP) Vs Data
                             Warehouse (OLAP)
                        </li>
                        <li>Whta is DMOL? Explain in short the syntax used and explain different OLAP operations.</li>
            ...
            <div class="col-lg-3 col-11 shadow mb-4 costume-shadow" id="paper-fourth-sem">
                ...
                <ol>
                    ...
                    <li><a href="#">Data Mining and Warehousing (Elective II)</a></li>
                </ol>
            </div>
        </div>
    </div>
