...
<head>
    ...
    <title>Linear Algebra (Com.Sc. MTH.121)</title>
    ...
    <div class="container" id="paper-container">
        <div class="row justify-content-center">
            ...
            <div class="col-lg-8 col-11 text-center border shadow mb-4" id="paper-model">
                ...
                <p>Linear Algebra (Com.Sc. MTH.121)</p>
                ...
                <div class="text-start">
                    <ol>
                        <li>Discuss the system of linear equations. Prove that the system of linear equation x + y = 5, x - y = 1, is consistent.</li>
                        <li>Find the inverse of matrix <img src="../../../images/la2.png" alt="" class="img-fluid"></li>
                        <li>Find the eigen value of matrix <img src="../../../images/la3.png" alt="" class="img-fluid"></li>
                        <li>For any two vector P, Q in <img src="../../../images/la4.png" alt="" class="img-fluid">, then <br>
                            a) P + Q = Q + P <br>
                            b) P.Q = Q.P <br>
                        </li>
                        <li>Prove that, If P and Q be two vectors in <img src="../../../images/la4.png" alt="" class="img-fluid">, then
                            <br> <img src="../../../images/la5.png" alt="" class="img-fluid">
                        </li>
                        <li>Prove that the product of a scalar and a linear transformation is also a linear transformation.</li>
                        <li>Find the orthogonal basis for  <img src="../../../images/la7.png" alt="" class="img-fluid"></li>
                        <li>What are the eigen values and eigen vectors of a matrix? Define characteristic equation with example.</li>
                        <h5 class="text-center">Group C</h5>
                        <b>
                            <p class="text-center">Attempt any two questions. (long questions) (2x16=32)</p>
                        </b>
                        <li>State and prove Cayley Hamilton Theorem and verify it for a square matrix of order 2 and 3.</li>
                        <li>If P and Q be two vectors in <img src="../../../images/la10a.png" alt="" class="img-fluid">, then prove that 
                            <img src="../../../images/la10b.png" alt="" class="img-fluid">
                        </li>
                        <li>Prove that, <br>
                            a) The composition of two linear transformation is also a linear transformation. <br>
                            b) The inverse of a linear transformation is linear transformation. <br>
                        </li>
                    </ol>
                </div>
            </div>
