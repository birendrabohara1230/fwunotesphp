...
<head>
    ...
    <title>Microprocessor System (Com.Sc. MPS.121)</title>
    ...
    <div class="container" id="paper-container">
        <div class="row justify-content-center">
            ...
            <div class="col-lg-8 col-11 text-center border shadow mb-4" id="paper-model">
                ...
                <p>Microprocessor System (Com.Sc. MPS.121)</p>
                ...
                <div class="text-start">
                    <ol>
                        <li>WAP in 8085 microprocessor to separate odd & even numbers from an array of 10 numbers stored in memory locations starting from 2050H. Store the odd numbers starting from 2060H & even number starting from 2070H onwards.</li>
                        <li>Three 8 bit numbers P, Q and R are stored in the registers B, C and D respectively. WAP in 8085 microprocessor to find the largest number among them and store it in the H register.</li>
                        <li>A set of numbers is stored in memory locations starting from xx25H. The last number is 45H. WAP in 8085 to find if a hex number AB exist in them. Also count total appearance of it if it exist.</li>
                        <li>Draw the block SAP-1 architecture and explain each block.</li>
                        <li>Draw the timing diagram of MVI A, 98H. Also explain it.</li>
                        <li>What do you mean by hyper threading? Differentiate between RISC and CISC architecture.</li>
                        <li>What is the signigicance of flag register in any microprocessor? Explain the flags of 8085 microprocessor.</li>
                        <li>What do you mean by interrupts? Explain maskable and non-maskable interrupt with example.</li>
                        <h5 class="text-center">Group C</h5>
                        <b>
                            <p class="text-center">Attempt any two questions. (long questions) (2x16=32)</p>
                        </b>
                        <li>a. Draw the architecture of basic microprocessor and explain each components of it in details. (10) <br>
                            b. Explain DMA with its advantages and applications. (6) 
                        </li>
                        <li>a. WAP to print the string "Microprocessor is good for programming" in 8086 microprocessor. (10) <br>
                            b. What do you understand by addressing modes? Explain implied addressing mode with example. (6)
                        </li>
                        <li>a. Draw the block diagram of RS-232C and explain with the example of null modem connection. (10)
                            <br>
                            b. WAP in 8085 microprocessor that loads any sixteen data into memory location starting from XX70H. Transfer  the entire block of data starting from XX40H in reverse order. (6)
                        </li>
            ...
            <div class="col-lg-3 col-11 shadow mb-4 costume-shadow" id="paper-fourth-sem">
                ...
                <ol>
                  ...
                  <li><a href="../DL/2071.php">Digital Logic Design</a></li>
                  <li><a href="#">Microprocessor System</a></li>
