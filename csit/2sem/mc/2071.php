...
<head>
    ...
    <title>Mechanics And Electrodynamics (Com. Sc. PHY 121)</title>
    ...
    <div class="container" id="paper-container">
        <div class="row justify-content-center">
            ...
            <div class="row text-center" id="paper-year">
                <div class="col-8">
                    <a href="2071.php"><button type="button" class="btn paper-year-style">2071</button></a>
                </div>
            </div>
            ...
            <div class="col-lg-8 col-11 text-center border shadow mb-4" id="paper-model">
                ...
                <p>Mechanics And Electrodynamics (Com. Sc. PHY 121)</p>
                ...
                <div class="text-start">
                    <ol>
                        <li>Find x-component of electric field at point (1,2) corresponding to potential
                            <img src="../../../images/me9.png" class="img-fluid"  alt=""></li>
                        <li>What do you mean by electric displacement current? Why did Maxwell; introduce it?</li>
                        <li>Define electrical image. Find out electric field intensity at a point due to point charge in case of grounded conducting sphere.</li>
                        <li>Define vector potential and magnetic vector potential. Deduce an expression for magnetic vector potential.</li>
                        <li>Prove <img src="../../../images/me13.png" class="img-fluid" alt="">, where symbols have their usual meaning.</li>
                        <li>Show that Newton's 2nd law of motion is real law motion. Write limitations of Newton's laws of motion.</li>
                        <li>State and prove the principle of conservation of angular momentum.</li>
                        <li>Show that the motion of a charged particle with transverse electric field is parabolic in nature. Also find the total shift of particle after emerging from the field.</li>
                        <h5 class="text-center">Group C</h5>
                        <b>
                            <p class="text-center">Attempt any two questions. (long questions) (2x16=32)</p>
                        </b>
                        <li>What do you mean by harmonic oscillator? Obtain relation between its acceleration and displacement. Show that the energy of harmonic oscillator is directly proportional to square of its amplitude.</li>
                        <li>Draw the energy level diagram of a diatomic molecule and explain its salient points. What is meant by the terms vibrational quantum number and zero point energy?</li>
                        <li>Derive formula for molecular find inside dielectric. Obtain boundary conditions for field vectors <img src="../../../images/me24.png" class="img-fluid" alt=""> near surface separating two media.</li>
                    </ol>
                </div>
            </div>
            <div class="col-lg-3 col-11 shadow mb-4 costume-shadow" id="paper-fourth-sem">
                ...
                <ol>
                    ...
                    <li><a href="#">Mechanics And Electrodynamics</a></li>
