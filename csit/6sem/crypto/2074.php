        ...
        <div class="row justify-content-center">
            ...
            <div class="col-lg-8 col-11 text-center border shadow mb-4" id="paper-model">
                ...
                <div class="text-start">
                    <ol>
                        <li>Define cryptography.explain cipher with suitable example.</li>
                        <li>Explain Elliptic curve cryptography in detail.</li>
                        <li>Explain chinese remainder theorem with suitable example.</li>
                        <li>How can you check integrity of a message? explain the properties of cryptographic hash
                            function.</li>
                        <li>What do you mean by web security ? differentiate between firewall and intrusion detection
                            system.</li>
                        <li>explain digital signature standard (DSS) algorithm. Verify it with suitable example.</li>
                        <li>Explain CMAC process. What is the number of padding bits if the length of the original
                            message is 2590 bits in case of SHA-512?</li>
                        <li>Write short notes on:(any two) <br>
                            i. HIll cipher <br>
                            ii. shannon's thepry <br>
                            iii. symmetric vs.Asymmetric cipher <br>
                        </li>
                        ...
                        <li>What is man-in-the-middle attack? Explain Diffie-Hellman key exchange algorithm with
                            suitable example.</li>
                        <li>What do you mean by Fermats and euler theorem? Explain modification detection code (MDC) i
                            details.</li>
                    </ol>
                </div>
            </div>
