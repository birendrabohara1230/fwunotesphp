        ...
        <div class="row justify-content-center">
            ...
            <div class="col-lg-8 col-11 text-center border shadow mb-4" id="paper-model">
                ...
                <div class="text-start">
                    <ol>
                       <li>What are the objectives of modern cryptography? Differentiate between cryptography and steganography.</li>
                       <li>Define security attack. Explain its types. Differentiate between symmetric and asymmetric cipher.</li>
                       <li>What is DES? Explain its features . EXplain one round of DES encryption.</li>
                       <li>Explain kerchoff's principle. Differentiate between block cipher and stream cipher.</li>
                       <li>What is cryptographic hash function? What are its application? explain SHA-512 algorithm with its block diagram.</li>
                       <li>What is length and padding field? What is the number of padding bits if the length of the original message is (a) 5060 bits (b) 20 bits  (c) 6666 bits?</li>
                       <li>Explain the types of intruders. Differentiate between firewall and IDS.</li>
                       <li>Write short notes on:(any two )</li>
                       <i class="kerberos">
                        ii.Affine cipher
                        iii.Chinese reminder theorem
                       </i>
                      ...
                      <li>What do you mean by man-in-the-middle attack? What are the security approaches of RSA algorithm? Explain RSA algorithm and trace it with suitable example.</li>
                      <li>How  can you define  digital signature? Explain digital signature standard (DSS) algorithm and trace it with example.</li>
                      <li>what are the properties of cryptographic hash function? How can you check integrity of a message? explain modification detection code with its block diagram and example./li>
