...
<head>
    ...
    <title>Introduction to Cryptography (CSIT.321)</title>
    ...
    <div class="container" id="paper-container">
        <div class="row justify-content-center">
            ...
            <div class="row text-center" id="paper-year">
                <div class="col-lg-8">
                    <a href="2074.htm"><button type="button" class="btn">2074</button></a>
            ...
            <div class="col-lg-8 col-11 text-center border shadow mb-4" id="paper-model">
                ...
                <p> Introduction to Cryptography (CSIT.321)</p>
                ...
                <div class="text-start">
                    <ol>
                        <li>What is the number of padding bits if the length of the original message is 2500 bits and
                            3005 bits in case SHA-512?</li>
                        <li> Explain different services provides by SSL.</li>
                        <li>How can you check integrity of a message?</li>
                        <li>What is the purpose of the S-boxes in DES?</li>
                        <li>Explain fermats and Euler theorem with suitable examples.</li>
                        <li>What are the objectives of modern cryptography?</li>
                        <li>Explain security attack.</li>
                        <li>Explain Elliptic curve cryptography.</li>

                        <h5 class="text-center">Group B</h5>
                        <b>
                            <p class="text-center">Attempt any five questions. (Short questions) (5x8=40)</p>
                        </b>
                        <li>Differntiate between block cipher and stream cipher. Encrypt the message "MEET ME IN THE
                            CLASS" using Rail fence cipher using depth 2 and also decrypt the encrytped message.</li>
                        <li>Encrypt the message "ALLCE" and "BoB" to playfair cipher using key "PLAYAIRENCRYPTION".</li>
                        <li>In a RSA system, a user has chosen the primes 11 and 17 to create a key pair. The public key
                            is (7,n) and the private key is (d,n). Decide the private key (d,n). Show encrytion and
                            decryption process for the message 88.</li>
                        <li>Explain digital signature standard (DSS) algorithm. Verify it with suitable example.</li>
                        <li>What is kerberos?Explain different servers of kerberos scheme.</li>
                        <li>Define cryptographic hash function. Explain SHA-512 algorithm with block diagram</li>

                        <h5 class="text-center">Group C</h5>
                        <b>
                            <p class="text-center">Attempt any three questions. (Long questions) (3x12=36)</p>
                        </b>
                        <li>Define primitive root of a prime number with suitable example. Given the prime number q=19,
                            the primitive root &#x0251;=2, private key of sender with X<sub>A</sub>=3 and random integer
                            t=5, encrypt the message M=16 using Elgamal encryption algorithm.</li>
                        <li>Compare the SHA parameters between SHA-160,SHA-256, SHA-384 and SHA-512. Encrypt the cipher
                            text "HATS" with the key <img src="../../../images/crypto16.png" alt=""
                                class="img-fluid">using Hill cipher and also decrypt it.</li>
                        <li>Define double and triple DES. Explain DES encryption algorithm with its block diagram.</li>
                        <li>Write down the features of AES. Explain the procedure of mix column transformation in AES
                            with an example.</li>
            ...
            <div class="col-lg-3 col-11 shadow mb-4 costume-shadow" id="paper-fourth-sem">
                ...
                <ol>
                    <li><a href="#">Introduction to Cryptography</a></li>
                    ...
                    <li><a href="../webII/2074.php">Web Tech II</a></li>
                    <li><a href="">Minor Project I</a></li>
                </ol>
            </div>
        </div>
    </div>
