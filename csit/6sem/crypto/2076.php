        ...
        <div class="row justify-content-center">
            ...
            <div class="col-lg-8 col-11 text-center border shadow mb-4" id="paper-model">
                ...
                <div class="text-start">
                    <ol>
                        <li>What is the purpose of the S-boxes in SBS? Explain 'f' function of DBS encryption algorithm.
                        </li>
                        <li>What is kerberos? Explain different servers of kerberos scheme.</li>
                        <li>How can you check integrity of a message? Explain the properties of cryptographic hash
                            function.</li>
                        <li>Explain Fermats and Euler theorem with suitable example.</li>
                        <li>Explain digital signature process with block diagram.</li>
                        <li>define cryptographic hash functionn. explain SHA-512 algorithm with block diagram.</li>
                        <li>Define virus? What is the purpose of creating virus?Explain diffeerent types of virus.</li>
                        <li>Write short notes on (any two ) <br>
                            i.Hill cipher <br>
                            ii.Shannon's theory <br>
                            iii. Web security
                        </li>
                        ...
                        <li>Explain elgamal encryption algorithm and trace it with suitable example.</li>
                        <li>Explain AES algorithm with its features and block diagram.</li>
                        <li>differentiate between firewall and intrusion detection system. Explain pretty Good privacy
                            (PGP) encryption and decryption process.</li>
