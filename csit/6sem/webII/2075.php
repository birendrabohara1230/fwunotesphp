        ...
        <div class="row justify-content-center">
            ...
            <div class="col-lg-8 col-11 text-center border shadow mb-4" id="paper-model">
                ...
                <div class="text-start">
                    <ol>
                        <li>What is PHP? Differentiate between compiled and interpreted language.</li>
                        <li>Explain basic syntax of PHP and explain different types of errors in PHP.</li>
                        <li>Why is PHP called loosely typed language? Explain the terms session fixation, escape output.
                        </li>
                        <li>Write short notes on class and object in PHP.</li>
                        <li>Explain the switch statement with code example.</li>
                        <li>explain different types of loops used in PHP.</li>
                        <li>Write in short about different types of array.</li>
                        <li>Different between from GET and POST method.</li>

                        <h5 class="text-center">Group C</h5>
                        <b>
                            <p class="text-center">Attempt any two questions. (2x16=32)</p>
                        </b>
                        <li>Explain different types of file inclusion method with examples and write a program to print
                            table of 5.</li>
                        <li>Explain the term session, cookie and explain the login process with code, consider required
                            consideration yourself.</li>
                        <li>/Explain different types off joins with examples and sql query result, consider tables
                            yourself.</li>
                    </ol>
                </div>
            </div>
