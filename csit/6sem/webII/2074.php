        ...
        <div class="row justify-content-center">
            ...
            <div class="col-lg-8 col-11 text-center border shadow mb-4" id="paper-model">
                ...
                <div class="text-start">
                    <ol>
                        <li>explain the architecture of web with pictorial representation.</li>
                        <li>Write short notes of filter input, XSS, cookie.</li>
                        <li>explain switch statement in PHP with example.</li>
                        <li>Explain file inclusion methods with their difference.</li>
                        <li>Write short notes on web CMS and write down the features of wordpress.</li>
                        <li>What is class, objects constructor and destructor in PHP, explain with code example.</li>
                        <li>what are the different types of loop used in PHP?</li>
                        <li>Write short notes on function, function arguments/ parameters with example.</li>

                        <h5 class="text-center">Group C</h5>
                        <b>
                            <p class="text-center">Attempt any two questions. (2x16=32)</p>
                        </b>
                        <li>Write difference between GET and POST method, write a program in PHP to collect data from a
                            form with the fields Full Name, Roll No, Address, Batch and print the data.</li>
                        <li>explain different types of array in PHP with xamples and write short note on session and
                            interface in PHP.</li>
                        <li>Explain different types of join with examples and pictorial representation.</li>
                    </ol>
                </div>
            </div>
