    ...
    <div class="container" id="paper-container">
        <div class="row justify-content-center">
            ...
            <div class="col-lg-8 col-11 text-center border shadow mb-4" id="paper-model">
                ...
                <p> Research methodology of computer science (CSIT.323)</p>
                ...
                <div class="text-start">
                    <ol>
                        <li>What is research? Why the research is necessary for computer science and information
                            technology?</li>
                        <li>Define the literature review. Point out the guidelines for conducting a literature survey.
                        </li>
                        <li>What is the research design? Discuss the needs of research design in research.</li>
                        <li>Define scientific research. Briefly discuss the characteristics of scientific research.</li>
                        <li>What do you understand as experimental research? Mention the advantages and disadvantages of
                            the field experiment.</li>
                        <li>What is the half-split method? If the correction coefficient of a test score is 0.85. Obtain
                            the reliability coefficient if i) the test is made just once (single test)  <br> ii) the test is
                            double <br> iii) the length of the test is four times <br> iv) the test is done seven times and  <br> v)
                            test increase nine times.</li>
                        <li>What is the schedule? Discuss the content of the schedule.</li>
                        <li>Calculate the correlation coefficient from the following data and interpret thw result.
                            <br>
                            <table class="table table-bordered">
                                <tr>
                                    <td>X</td> <td>2</td> <td>7</td> <td>4</td> <td>2</td> <td>0</td> <td>4</td> <td>1</td> <td>2</td>
                                </tr>
                                <tr>
                                    <td>Y</td> <td>11</td> <td>18</td> <td>9</td> <td>4</td> <td>7</td> <td>6</td> <td>3</td> <td>8</td>
                                </tr>
                            </table>
                        </li>
                        ...
                        <li>Explain the major steps of the research process with suitable examples.</li>
                        <li>What is the thesis? Discuss the main elements of the thesis?</li>
                        <li>Define sampling and describe the different types of non-probability smpling.</li>
