        ...
        <div class="row justify-content-center">
            ...
            <div class="col-lg-8 col-11 text-center border shadow mb-4" id="paper-model">
                ...
                <div class="text-start">
                    <ol>
                        <li>Define research problem? Discuss about the guidelines for selecting the meaningful research
                            problem.</li>
                        <li>What is research design? Mention the characteristics of good research design?</li>
                        <li>Point out the advantages and disadvantages of laboratory experiment?</li>
                        <li>What is reliabilit? If the correlation coefficient of a test score is 0.80, obtain the
                            reliability coefficient if <br> i) the test is made just once (single test) <br> ii) the test is
                            double <br> iii) the length of test is four times <br> iv) the test is done five times <br> v) the test is
                            done seven times and <br> vi) test increase nine times.</li>
                        <li>What are differences between primary and secondary data?</li>
                        <li>The reliability coefficient of a test is found 0.75 with mean score as 65 and s.d. of 12 Mr.
                            sudama obtain a score 55 on the test. What is the true score? Also computer 95% confidence
                            interval for the true value.</li>
                        <li>What are the major characteristics of scientific research?</li>
                        <li>Briefly discuss about Latin square design with suitable examples?</li>
                        ...
                        <li>Briefly explain the different steps/process of research.</li>
                        <li>What is sampling? Describe different types of probability sampling.</li>
                        <li>What is research report? Discuss the major components of research report.</li>
