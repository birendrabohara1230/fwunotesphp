...
<head>
    ...
    <title>Research Methodology for computer science (CSIT.323)</title>
    ...
    <div class="container" id="paper-container">
        <div class="row justify-content-center">
            ...
            <div class="col-lg-8 col-11 text-center border shadow mb-4" id="paper-model">
                ...
                <p> Research Methodology for computer science (CSIT.323)</p>
                ...
                <div class="text-start">
                    <ol>
                        <li>Define research design. Describe the major elements of research design with suitable
                            diagram?</li>
                        <li>Distinguish between qualitative research and quantitative research.</li>
                        <li>What is reliabilit? If the correlation coefficient of a test score is 0.80, obtain the
                            reliability coefficient if i) the test is made just once (single test) ii) the test is
                            double iii) the length of test is four times iv) the test is done five times v) the test is
                            done seven times and vi) test increase nine times.</li>
                        <li>The reliability coefficient of a test is found 0.6 wuth mean score as 55 and standard
                            deviation of 8.Mr john obtains a score 46 on the test. What is the true score? also computer
                            95% confidence interval for the true value.</li>
                        <li>What are differences between primary and secondary data?</li>
                        <li>Write down the essential components needed for publication of research paper on research
                            journal.</li>
                        <li>Define ethical issue. What do you meant informed consent and why it is important for
                            research work?</li>
                        <li>What are the differnces between schedule and questionnaire?</li>
                        ...
                        <li>Research is a systematic way of searching new knowledge " mention about the different steps
                            of research process which are used by research during their research work.</li>
                        <li>What is theis? Describe the different parts of thesis which are necessary for the research
                            report.</li>
                        <li>What is sampling? Describe the different types of probability sampling.</li>
            ...
            <div class="col-lg-3 col-11 shadow mb-4 costume-shadow" id="paper-fourth-sem">
                ...
                <ol>
                    ...
                    <li><a href="#">Research Methodology for CS</a></li>
                    <li><a href="../se/2074.php">Software Engineering</a></li>
                    <li><a href="../webII/2074.php" href="">Web Tech II</a></li>
