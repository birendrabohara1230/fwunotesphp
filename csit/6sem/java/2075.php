...
<head>
    ...
    <title>Java programming (CSIT.322)</title>
        ...
        <div class="row justify-content-center">
            ...
            <div class="col-lg-8 col-11 text-center border shadow mb-4" id="paper-model">
                ...
                <div class="text-start">
                    <ol>
                        <li>List out main features of java programming? Explain java virtual machine with example.</li>
                        <li>Differentiate between interface and abstract class. Explain interface with example.</li>
                        <li>What is paxkage? Write down steps to create package in java with example.</li>
                        <li>What is collection in java? Write a java program to illustrate use of link list class with
                            example.</li>
                        <li>Discuss the term try, catch and finally with regarding exception in java.</li>
                        <li>Differentiate between break and continue statements with example.</li>
                        <li>Write a program to write "welcome" message to file and to read from same file in java.</li>
                        <li>Write short notes (any two) <br>
                            i. Access specifier <br>
                            ii. Polymorphism <br>
                            iii. Final keyword
                        </li>
                        ...
                        <li>Define multithreading. List out its advantages. Explain the life cycle of thread with state
                            diagram and programming example.</li>
                        <li>What are the advantage of using inheritance?How do you implement multiple inheritances in
                            java?</li>
                        <li>Draw flowchart of if else if statements and solve the following problems. Write a program to
                            find net bill amount for electricity consumed: If consumed unit is less or equal to 80, cost
                            will be 100, If consumed unit is greater than 80 and less than 200, rate for all units above
                            80 will be NRs7.5 If the consumed unit is greater than 300 than, rate is NRs.12.</li>

                    </ol>
                </div>
            </div>
            <div class="col-lg-3 col-11 shadow mb-4 custome-shadow" id="paper-fourth-sem">
                <h4>Sixth Semester</h4>
                <ol>
                    <li><a href="../crypto/2074.php">Introduction to Cryptography</a></li>
                    <li><a href="#">Java Progamming I</a></li>
