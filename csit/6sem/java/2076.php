        ...
        <div class="row justify-content-center">
            ...
            <div class="col-lg-8 col-11 text-center border shadow mb-4" id="paper-model">
                ...
                <div class="text-start">
                    <ol>
                        <li>What are various advantages of using package in java? Write downs steps to create package
                            with
                            example.</li>
                        <li>What are constructors? Write a java to define a class, describe its constructor, overload
                            the
                            constructors and instantiate its object.</li>
                        <li>How class and objects are create in java? Explain features of java in brief.</li>
                        ...
                        <li>What is collection in java? Write a java program to illustrate use of link list class with
                            example.</li>
                        <li>Demonstrate the application of super and final keywords in java.</li>
                        <li>Write short notes (any two) <br>
                            i. Method overriding <br>
                            ii. Appiet <br>
                        ...
                        <li>Define inheritance. Explain types of inheritance in java. How we can implement multiple in
                            heritance in java with example?</li>
                        <li>Define exception. Differentiate between checked and unchecked exception in java write a
                            program
                            to implement the concept of exception Handling by creating user define exceptios.</li>
