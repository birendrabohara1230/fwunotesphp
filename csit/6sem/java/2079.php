        ...
        <div class="row justify-content-center">
            ...
            <div class="row text-center" id="paper-year">
                <div class="col-8">
                    ...
                    <a href="2075.php"><button type="button" class="btn">2076</button></a>
            ...
            <div class="col-lg-8 col-11 text-center border shadow mb-4" id="paper-model">
                ...
                <div class="text-start">
                    <ol>
                        <li>Write down any two difference between application and applet.</li>
                        <li>What is command line argument in java?</li>
                        <li>What is garbage collection in java?</li>
                        <li>Define synchronization in java.</li>
                        <li>What is collection? Why is it used?</li>
                        <li>What are the advantages of inheritance?</li>
                        <li>How array is created in java?</li>
                        <li>What is the use of super keyword in java?</li>

                        <h5 class="text-center">Group B</h5>
                        <b>
                            <p class="text-center">Attempt any five questions. (Short questions) (5x8=40)</p>
                        </b>
                        <li>What is package? How do you create your own package in java?</li>
                        <li>Write a program to input age and name of a student and display the same using scanner and
                            Buffered Reader class.</li>
                        <li>Why is it important to handle exception? Write a program to illustrate exception handling.
                        </li>
                        <li>Explain the function of final keyword with regard to variable, method and class.</li>
                        <li>Differentiate between method overloading and method overriding.</li>
                        <li>What is array list? Write a program to demonstrate working of Array list in java.</li>

                        <h5 class="text-center">Group C</h5>
                        <b>
                            <p class="text-center">Attempt any three questions. (Long questions) (3x12=36)</p>
                        </b>
                        <li>What is interface? How do you implement multiple inheritance in java?</li>
                        <li>What are the features of java programming? Describe java and internet in brief.</li>
                        <li>Explain different state in a thread's life cycle. Write a program to create thread.</li>
                        <li>Explain the following terms with reference to java: <br>
                            i. Throw and throws <br>
                            ii. Java virtual machine <br>
                            iii. Innerclass <br>
                        </li>
