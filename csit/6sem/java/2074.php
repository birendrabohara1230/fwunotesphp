            ...
            <div class="col-lg-8 col-11 text-center border shadow mb-4" id="paper-model">
                ...
                <div class="text-start">
                    <ol>
                        ...
                        <li>Write a CUI program to accept two numbers and save its sum in file "sum.dat".</li>
                        <li>What is package? Write down steps to create package in java with example.</li>
                        <li>What are the main features of java programming?</li>
                        <li>Define polymorphism. Explain function overriding with example.</li>
                        <li>What is collection in java? Write program for linked list class. </li>
                        <li>Write a java program to find greatest number among three numbers entered by user.</li>
                        <li>Explain exception handling with example.</li>
                        ...
                        <li>Draw flowchart of if else if statements and solve the following problems. Write a program to
                            ...
                            80 will be NRs.7.5. 
                            <br>
                            If the consumed unit is greater than 300 than, rate is NRs. 12.
                        </li>
                        <li>What is multithreading. List out its significance. Explain the life cycle of Thread with
                            state diagram and programming example.</li>
                        <li>Mention the syntax and structures of single, multilevel and multiple inheritance. Write down
                            the program to implement multiple inheritance in java.</li>
                    </ol>
                </div>
            </div>
