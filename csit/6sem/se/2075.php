        ...
        <div class="row justify-content-center">
            ...
            <div class="col-lg-8 col-11 text-center border shadow mb-4" id="paper-model">
                ...
                <div class="text-start">
                    <ol>
                        <li>What is software process model? discuss re-use oriented development in detail.</li>
                        <li>Discuss requirement elicitation and analysis activity of requirement engineering process.
                        </li>
                        <li>Explain the sequence diagram with example.</li>
                        <li>Describe the application domain of software.</li>
                        <li>Define software process. Explain activities of software process.</li>
                        <li>Explain various types of software myths.</li>
                        <li>What is component based development? Explain with advantages.</li>
                        <li>Differentiate between function and non-functional requirements.</li>
                        <h5 class="text-center">Group C</h5>
                        <b>
                            <p class="text-center">Attempt any two questions. (2x16=32)</p>
                        </b>
                        <li>Define UML and explain any five UML diagrams.</li>
                        <li>Describe various activities of requirement engineering process.</li>
                        <li>What is system modeling and architecture desing? Describe context, interaction, structural
                            and behavioral models with examples. </li>
                    </ol>
                </div>
            </div>
