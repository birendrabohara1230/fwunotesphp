...
<head>
    ...
    <title>Software Engineering (CSIT.324)</title>
    ...
    <div class="container" id="paper-container">
        <div class="row justify-content-center">
            ...
            <div class="col-lg-8 col-11 text-center border shadow mb-4" id="paper-model">
                ...
                <p> Software Engineering (CSIT.324)</p>
                ...
                <div class="text-start">
                    <ol>
                        <li>What is software engineering? Explain application od software.</li>
                        <li>Briefly describe software engineering process.</li>
                        <li>Explain RED and agile software development process model.</li>
                        <li>Explain black box and white box testing with their merits and demerits.</li>
                        <li>What is model driven engineering described briefly.</li>
                        <li>Be defining architecture view, explain various types of architecture views.</li>
                        <li>Explain change management.</li>
                        <li>What is software maintenance? Discuss types of software management.</li>

                        <h5 class="text-center">Group C</h5>
                        <b>
                            <p class="text-center">Attempt any two questions. (2x16=32)</p>
                        </b>
                        <li>Define requirement understanding and types of software requirement. Explain requirement
                            engineering process.</li>
                        <li>What is system architecture? Describe context model, interaction model and structural model.
                        </li>
                        <li>Define architecture patterns. Explain layered repository and pipe and filter architecture.
                        </li>
