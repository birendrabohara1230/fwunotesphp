        ...
        <div class="row justify-content-center">
            ...
            <div class="col-lg-8 col-11 text-center border shadow mb-4" id="paper-model">
                ...
                <div class="text-start">
                    <ol>
                        <li>Describe the characteristics of good software and explain charging nature of software.</li>
                        <li>What is software engineering? Write application domain of software.</li>
                        <li>Describe waterfall model with advantages and disadvantages.</li>
                        <li>Explain the structure of requirement document in details.</li>
                        <li>Mention the requirement elicitation process.</li>
                        <li>What is software maintenance and software re-engineering?</li>
                        <li>Define software quality assurance? explain elements of software quality assurance.</li>
                        <li>Write short notes (any two) <br>
                            i. White box testing <br>
                            ii. Structure model
                        </li>
                        ...
                        <li>Define UML and explain any six UML diagram.</li>
                        <li>What is project management? Describe project management activities.</li>
                        <li>Explain prototype model and spiral model of software development.</li>
