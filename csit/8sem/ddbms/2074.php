...
<head>
    ...
    <title>Distributed Database Management System (CSIT. 424.2)</title>
    ...
    <div class="container" id="paper-container">
        <div class="row justify-content-center">
            ...
            <div class="col-lg-8 col-11 text-center border shadow mb-4" id="paper-model">
                ...
                <p>Distributed Database Management System (CSIT. 424.2)</p>
                ...
                <div class="text-start">
                    <ol>
                        <li>What are the factors Encouraging DDBMS? Discuss the advantage of DDBMS.</li>
                        <li>What are the various kinds of transparencies in distributed database design? Explain each with suitable example.</li>
                        <li>What is distributed deadlock preventation? Expalin one of the schemes of distributed deadlock detection and recovery.</li>
                        <li>What is concurrency control in DDBMS? Explain the Optimistic Concurrency Control Algorithm.</li>
                        <li>Explain the phases of query processing in distribted database.</li>
                        <li>What is horizontal and vertical fragmentation explains these.</li>
                        <li>What is authorization control? How do imply authorization control in a distributed environment?</li>
                        <li>What is checkpoint? Explain Fuzzy Check pointing with example.</li>
                        ...
                        <li>Explain Architectural Models of distributed database system with block diagram.</li>
                        <li>What are the different types of commit protocol used in distributed database explain each of them in details?</li>
                        <li>Consider the following ralation: BOOKS (Book#, author, topic, Total_Stock, Price) BOOKSTORE(Store#, City, Zip, inventory_value), STOCK(store#, Book#, Qty) Total_Stock is the total numbers of books in stock and inventory_value is the total inventory value for the store in Rs. Design a global schema for the abouve database. Give an example of two simple predicates that would be meaningful for the BOOKSTORE relation for horizontal partitioning.</li>
                    </ol>
                </div>
            </div>
