...
<head>
    ...
    <title>Advanced Database Design (CSIT. 423.2)</title>
    ...
    <div class="container" id="paper-container">
        <div class="row justify-content-center">
            ...
            <div class="col-lg-8 col-11 text-center border shadow mb-4" id="paper-model">
                ...
                <p>Advanced Database Design (CSIT. 423.2)</p>
                ...
                <div class="text-start">
                    <ol>
                        <li>Explain four desirable properties of a transaction. Describe transcation state diagram in
                            brief.</li>
                        <li>What is lock? Explain shared and exclusive locks with example.</li>
                        <li>Explain Sparse, Dense and Mluti level index with example.</li>
                        <li>What is database recovery? Explain shadow paging with example.</li>
                        <li>Explain the importance of data integrity in DBMS.</li>
                        <li>What is a deadlock? How are deadlocks prevented?</li>
                        <li>List out factors for measuring performance of disk. Explain hashing in brief.</li>
                        <li>List out factors for measuring cost of query. Describe transformation rule with example.
                        </li>
                        ...
                        <li>What is qeury processing? Explain steps in query processing with diagram and example.</li>
                        <li>Compare various file orgranizations with example. Also mention storage device hierarchy in
                            brief.</li>
                        <li>Explain RAID Technology up to three levels with example.</li>
                    </ol>
                </div>
            </div>
