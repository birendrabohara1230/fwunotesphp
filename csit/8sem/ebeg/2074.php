...
<head>
    ...
    <title>E-Business and E-Governance (CSIT. 425.2)</title>
    ...
    <div class="container" id="paper-container">
        <div class="row justify-content-center">
            ...
            <div class="col-lg-8 col-11 text-center border shadow mb-4" id="paper-model">
                ...
                <p>E-Business and E-Governance (CSIT. 425.2)</p>
                ...
                <div class="text-start">
                    <ol>
                        <li>Define e-governance. Why e-governance is necessary? Write advantages of e-governance.</li>
                        <li>What are the problems encountered in achieving e-governance in the context of Nepal?</li>
                        <li>Discuss the legal infrastructure preparedness of e-governance.</li>
                        <li>Write the application area of data warehouse and data mining?</li>
                        <li>Describe the action plan of ICT policy 2072.</li>
                        <li>Explain the dissemination of information Technology.</li>
                        <li>What is cyber law? Describe the needs of cyber law.</li>
                        <li>Explain maturity model.</li>
                        ...
                        <li>Describe data warehouse and data mining. Write advantages of data warehouse and data mining.</li>
                        <li>Describe the scope, content and present global trends of growth in e-governance.</li>
                        <li>What is model of digital E-Governance? Explain any three model of digital governance.</li>
                    </ol>
                </div>
            </div>
